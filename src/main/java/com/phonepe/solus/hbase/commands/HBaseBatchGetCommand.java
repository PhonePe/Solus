...
public class HBaseBatchGetCommand extends GenericHBaseCommand<Result[]> {
    private final List<Get> gets;

    @Builder
    public HBaseBatchGetCommand(final List<Get> gets,
                                final HBaseTableConnection connection,
                                final String table) {
