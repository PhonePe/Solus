...
solusEngine.
        ...
        add("coupons","COUPON-ABC-123",86400000L);  // 24 hours TTL
...
config.
        ...
        set("hbase.zookeeper.quorum","zk1.example.com,zk2.example.com");
...
solusEngine.
        ...
        add("events","event-12345",3600000L);  // 1 hour TTL
```
...
**Note**: Due to the probabilistic nature of Bloom filters, `checkAbsence()` returning `false` guarantees the entity was
seen before, but returning `true` has a small probability of being a false positive.
